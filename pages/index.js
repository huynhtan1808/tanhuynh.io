    ...
    <Container>
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
        ...
        <h2 className="prose text-gray-600 dark:text-gray-400 mb-16">
          Hiện đang là web developer, designer, writer. Đồng thời là Founder của <Link href="https://onepixelmedia.com"><a target="_blank">One Pixel Media</a></Link>. Bạn đã tìm thấy blog cá nhân của mình – Bạn có thể&nbsp;
          <Link href="/contact">
            <a>Liên hệ mình</a>
          </Link>
